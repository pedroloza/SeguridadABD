...
INSERT INTO public.guardiaseguridad(
	"id", "c.i", "nombre", apellido, genero, nacionalidad, telefono, fecha_de_nacimiento, edad_servicio_militar,tiempo_servicio_militar)
...
(
    ...
    CONSTRAINT actividad_servicio_pkey PRIMARY KEY ("ID")
)
INSERT INTO public.actividad_servicio(
	"id", "nombre_tipo_de_servicio", "tiempo_experiencia_minima", "tipo_de_dificultad", "remuneracion", "horas_laborables")
...
(
	...
	"id", "ruc", "Nombre_empresa", contacto_telefonico, direccion, pagina_web, correo_eletronico, "Nombre_Responsable")
...
INSERT INTO public.instructor(
	id, "c.i", nombre, apellido, telefono, tiempo_que_estuvo_en_el_cargo)
